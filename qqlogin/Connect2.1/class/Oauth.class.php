...
require_once(QQ_CONNECT_CLASS_PATH."Recorder.class.php");
require_once(QQ_CONNECT_CLASS_PATH."URL.class.php");
require_once(QQ_CONNECT_CLASS_PATH."ErrorCase.class.php");
